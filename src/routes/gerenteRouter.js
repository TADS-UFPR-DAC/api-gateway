...
gerenteRouter.put("/aprova/:id", auth, access.managerAccess, gerenteController.aprovarAutocadastro);
gerenteRouter.put("/reprova/:id", auth, access.managerAccess, gerenteController.reprovarAutocadastro);
